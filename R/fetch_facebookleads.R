#' fetch_facebookleads
#' A function to fetch Facebook Leads Ads data from the windsor.ai API
#'
...
#' @examples
#' \dontrun{
#' my_facebookleads_data <- fetch_facebookleads(api_key = "your api key",
...
fetch_facebookleads <-
  function(api_key,
    ...
    json_data <- jsonlite::fromJSON(
      paste0(
        "https://connectors.windsor.ai/facebook_leads?api_key=",
        api_key,
        "&fields=",
